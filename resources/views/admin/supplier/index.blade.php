...
@push('js')
    <script>
        $(document).ready(function() {
            ...
            const routeDestroy = '{{ route('admin.suppliers.destroy') }}';
            const routeRestore = '{{ route('admin.suppliers.restoreAll') }}';
            const routeForceDelete = '{{ route('admin.suppliers.forceDelete') }}';
