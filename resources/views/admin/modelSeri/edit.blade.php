                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="name" placeholder="Tên seri"
                                                name="name" required value="{{ $modelSeries->name }}">
...
@push('js')
    <script>
        $(document).ready(function() {
            ...
            const routeUpdate =
                "{{ route('admin.brands.modelSeries.update', ['modelSeries' => $modelSeries->slug, 'brand' => $brand->slug]) }}";
            const routeIndex = '{{ route('admin.brands.modelSeries.index', $brand->slug) }}';
