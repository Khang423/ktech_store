...
@push('js')
    <script>
        $(document).ready(function() {
            ...
            const routeDestroy = '{{ route('admin.categoryProducts.destroy') }}';
            const routeRestore = '{{ route('admin.categoryProducts.restoreAll') }}';
            const routeForceDelete = '{{ route('admin.categoryProducts.forceDelete') }}';
